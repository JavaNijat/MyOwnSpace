package Homework4_Ahappyfamily;

import java.util.ArrayList;
import java.util.List;

public class Homework4_Ahappyfamily {
    public static void main(String[] args) {
        ...
        // 1
        Human Nijat= new Human("Nijat","Javadov",2000,105,new Human("Kamil","Javadov",1970),new Human(),new Pet("cat","Mur", 3,60, new String[]{"eat", "play", "sleep"}));
        Human Ariz= new Human("Fuad","Javadov",1970,107,new Human(),new Human("Murad","Javadov",1970),new Pet("cat","Mur", 3,60, new String[]{"eat", "play", "sleep"}));
        Human Ulker= new Human("Ahmed","Javadov",1970,110,new Human(),new Human("Farid", "Javadov",1942),new Pet("cat","Mur", 3,60, new String[]{"eat", "play", "sleep"}));
